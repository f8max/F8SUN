...
| S02 | PCI SSC | E-commerce Guidance for PCI DSS Requirements 6.4.3 and 11.6.1, Jan 2025 | https://www.pcisecuritystandards.org/wp-content/uploads/2025/01/Guidance-for-PCI-DSS-Requirements-6_4_3-and-11_6_1.pdf | payment-page scripts, authorization, integrity | active guidance |
| S03 | PCI SSC | Payment Page Security and Preventing E-Skimming guidance | https://www.pcisecuritystandards.org/standards/e-commerce-guidance/ | e-skimming controls and resource hub | active landing page |
...
| S19 | Mastercard | Identity Check / EMV 3DS | https://www.mastercard.com/global/en/business/cybersecurity-fraud-prevention/identity-check.html | scheme implementation example | scheme material; not independent evidence |
...
| S22 | PayPal | Fraud Protection documentation | https://developer.paypal.com/docs/checkout/advanced/customize/fraud-protection/ | vendor rules/filters implementation example | vendor example |
...
| S26 | EBA | Opinion on new types of payment fraud and possible mitigants, 29 Apr 2024 | https://www.eba.europa.eu/publications-and-media/press-releases/eba-opinion-new-types-payment-fraud-and-possible-mitigants | social engineering/payment fraud context | official supervisory opinion |
...
| S28 | Банк России | Признаки осуществления перевода денежных средств без добровольного согласия клиента | https://cbr.ru/analytics/ib/operations_sans_consent/ | current official list/context of indicators | dynamic regulator page |
...
| S33 | Банк России / ФинЦЕРТ | Обзор операций, совершённых без добровольного согласия клиентов, 2024 | https://cbr.ru/analytics/ib/review_2024/ | Russian fraud statistics/context | official retrospective data; not universal benchmark |
...
| S39 | Visa | Visa Account Attack Intelligence / enumeration overview | https://usa.visa.com/solutions/visa-account-attack-intelligence.html | scheme vendor implementation example for enumeration detection | vendor/scheme marketing example only |
